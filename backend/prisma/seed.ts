...
const main = async () => {
  ...
  await prisma.product.createMany({
    ...
    //     sizes: ['S'],
    //     description:
    //       'Хаки, жоржет, полупрозрачный дизайн, драпировка, кушак, вырез халтер, моде��ь на о��но�� плече, длина ма��си, дв��хс��ой���ый материал.',
    //     country: '��ра���ци����',
    //     composition: '��ол��эс��ер 100%',
    ...
    data: [
      {
        ...
        category: 'Низ',
        color: 'Черный',
        imageUrl: 'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1750001657/men_1_dlqfyc.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        ...
        description: '',
        country: '',
        composition: 'ОРГАНИЧЕСКИЙ ХЛОПОК 100%',
        instructions: 'РУЧНАЯ СТИРКА',
        gender: 'Муж',
        category: 'Верх',
        color: 'Бежевый',
        imageUrl: 'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1750001658/men_2_kwyngf.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'БРЮКИ ЭФФЕКТ КРАСКИ',
        price: 21000,
        sizes: ['L', 'XL'],
        description: '',
        country: '',
        composition: 'ХЛОПОК 90%, ПОЛИЭСТЕР 7%, ПРОРЕЗИНЕННОЕ ВОЛОКНО 3%',
        instructions: 'РУЧНАЯ СТИРКА',
        gender: 'Муж',
        category: 'Низ',
        color: 'Белый',
        imageUrl: 'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1750001658/men_3_bdwehq.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'ШИРОКИЕ БРЮКИ',
        ...
        category: 'Низ',
        color: 'Черный',
        imageUrl: 'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1750001657/men_4_lozeeb.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'ТОП БЕЗ РУКАВОВ',
        ...
        category: 'Верх',
        color: 'Черный',
        imageUrl: 'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1750001657/men_5_ohyykn.webp',
        brandId: '67c3899f9a7d257532374940',
      },
    ],
  });
