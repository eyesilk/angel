...
const main = async () => {
  ...
  await prisma.product.createMany({
    ...
    //     sizes: ['S'],
    //     description:
    //       'Черный, смесовый хлопок, саржевое переплетение, застежка на завязке сзади, потайная застежка на молнии сзади, квадратный вырез, люверсы, ����нуровка, без бретелей, вырезные детали, модель без подкладки, асимметричный подол, длина до бедер.',
    //     country: 'Франция',
    ...
    //     instructions: 'Т��лько сухая чистка',
    //     gender: 'Жен',
    //     category: 'Платья',
    //     color: 'Бежевый',
    //     imageUrl:
    ...
    data: [
      {
        name: 'БЛУЗКА С ДРАПИРОВКОЙ',
        price: 10200,
        sizes: ['XS', 'S', 'M', 'L'],
        description: '',
        country: '',
        composition: 'КУПРО 92%, СПАНДЕКС/ЭЛАСТАН 8%',
        instructions: 'РУЧНАЯ СТИРКА',
        gender: 'Жен',
        category: 'Верх',
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813982/women_1_httrdb.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'ЮБКА МАКСИ С ОБОРКАМИ',
        price: 15300,
        sizes: ['XS', 'S', 'M', 'L'],
        description: '',
        country: '',
        ...
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813983/women_2_wlyace.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'БРЮКИ РАСКЛЕШЕННЫЕ',
        price: 17000,
        sizes: ['XS', 'S', 'M', 'L'],
        description: '',
        country: '',
        composition: 'FSC-СЕРТИФИЦИРОВАННАЯ ВИСКОЗА 85%, ПОЛИАМИД 9%, ЭЛАСТАН 6%',
        instructions: 'РУЧНАЯ СТИРКА',
        gender: 'Жен',
        category: 'Низ',
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813982/women_3_lj6jwz.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'ТОП ПОЛУПРОЗРАЧНЫЙ',
        price: 7000,
        sizes: ['XS', 'S', 'M', 'L'],
        description: '',
        country: '',
        composition: 'ВИСКОЗА ECOVERO (LENZING) 58%, ВИСКОЗА 42%',
        instructions: 'ТОЛЬКО СУХАЯ ЧИСТКА',
        gender: 'Жен',
        category: 'Верх',
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813983/women_4_noanbu.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        name: 'ТОП С ДРАПИРОВКОЙ',
        price: 10000,
        sizes: ['XS', 'S', 'M', 'L'],
        description: '',
        country: '',
        ...
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813983/women_5_lbcqjb.webp',
        brandId: '67c3899f9a7d257532374940',
      },
      {
        ...
        description: '',
        country: '',
        composition: 'АЦЕТАТ 61%, ВИСКОЗА 39%',
        instructions: 'ТОЛЬКО СУХАЯ ЧИСТКА',
        gender: 'Жен',
        category: 'Верх',
        color: 'Черный',
        imageUrl:
          'https://res.cloudinary.com/dr3gzvaqk/image/upload/v1749813984/women_6_uxnqkf.webp',
        brandId: '67c3899f9a7d257532374940',
      },
    ],
  });
